...
# SOP 自我进化：随 Django 进程自动后台扫描（无需单独 cron）
SOP_EVOLUTION_AUTOSTART = os.getenv("SOP_EVOLUTION_AUTOSTART", "true").lower() == "true"
SOP_EVOLUTION_INTERVAL_SECONDS = int(os.getenv("SOP_EVOLUTION_INTERVAL_SECONDS", "3600") or 3600)
SOP_EVOLUTION_BATCH_LIMIT = int(os.getenv("SOP_EVOLUTION_BATCH_LIMIT", "40") or 40)
SOP_EVOLUTION_UNUSED_BRANCH_MIN_RUNS = int(os.getenv("SOP_EVOLUTION_UNUSED_BRANCH_MIN_RUNS", "5") or 5)

# 企业微信持久化队列：随 Django 进程自动处理绑定/通知/待办同步
WECOM_QUEUE_AUTOSTART = os.getenv("WECOM_QUEUE_AUTOSTART", "true").lower() == "true"
WECOM_QUEUE_INTERVAL_SECONDS = int(os.getenv("WECOM_QUEUE_INTERVAL_SECONDS", "30") or 30)
WECOM_QUEUE_BATCH_LIMIT = int(os.getenv("WECOM_QUEUE_BATCH_LIMIT", "100") or 100)
