...
urlpatterns = [
    ...
    path("assets/id/<int:asset_id>/sop/", views.asset_sop_update, name="skill-asset-sop"),
    path("assets/id/<int:asset_id>/publish-sop/", views.asset_publish_sop, name="skill-asset-publish-sop"),
    path("assets/id/<int:asset_id>/usage/", views.asset_usage_history, name="skill-asset-usage"),
    path("assets/id/<int:asset_id>/files/", views.asset_files, name="skill-asset-files"),
    path("assets/id/<int:asset_id>/files/<path:file_path>/", views.asset_file_detail, name="skill-asset-file-detail"),
